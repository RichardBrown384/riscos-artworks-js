/*
Example: 004-blend-polygons-to-square
...
const GROUP_1_END_PATH = createClosedNSidedPolygon(4, 1_050_000, 450_000, 50_000);

const GROUP_2_START_PATH = createClosedNSidedPolygon(6, 150_000, 750_000, 50_000);
const GROUP_2_END_PATH = createClosedNSidedPolygon(4, 1_050_000, 750_000, 50_000);

const GROUP_3_START_PATH = createClosedNSidedPolygon(7, 150_000, 1_050_000, 50_000);
const GROUP_3_END_PATH = createClosedNSidedPolygon(4, 1_050_000, 1_050_000, 50_000);

const GROUP_4_START_PATH = createClosedNSidedPolygon(8, 150_000, 1_350_000, 50_000);
const GROUP_4_END_PATH = createClosedNSidedPolygon(4, 1_050_000, 1_350_000, 50_000);

const GROUP_5_START_PATH = createClosedNSidedPolygon(9, 150_000, 1_650_000, 50_000);
const GROUP_5_END_PATH = createClosedNSidedPolygon(4, 1_050_000, 1_650_000, 50_000);

const GROUP_6_START_PATH = createClosedNSidedPolygon(10, 150_000, 1_950_000, 50_000);
const GROUP_6_END_PATH = createClosedNSidedPolygon(4, 1_050_000, 1_950_000, 50_000);

const GROUP_7_START_PATH = createClosedNSidedPolygon(11, 150_000, 2_250_000, 50_000);
const GROUP_7_END_PATH = createClosedNSidedPolygon(4, 1_050_000, 2_250_000, 50_000);
