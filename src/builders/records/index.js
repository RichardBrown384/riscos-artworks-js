...
module.exports.RecordEllipse = require('./ellipse');
...
module.exports.RecordRectangle = require('./rectangle');
module.exports.RecordRoundedRectangle = require('./rounded-rectangle');
